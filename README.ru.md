...
Отдельный выбор языка и голоса TTS — следующий этап аудионастроек. Он не будет зависеть
от языка интерфейса: например, английский UI можно будет использовать с русским голосом.
...
Текущий regression suite: **790 Python-тестов + 16 desktop-тестов + 8/8 acceptance-сценариев оркестратора**.
