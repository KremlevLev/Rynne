...
Эта модель лицензирования применяется к покрытым версиям, впервые опубликованным **10 августа 2026 года** или позднее. Каждая такая версия переходит под Apache License 2.0 через два года после даты её первой публикации. Ранее опубликованные под Apache 2.0 версии сохраняют исходную лицензию. Альтернативные коммерческие условия можно запросить у правообладателя через контакт владельца репозитория.
