...
Orpheus, стили речи и кнопка предпрослушивания у каждого голоса. Такое разделение не
...
Текущий regression suite: **796 Python-тестов + 16 desktop-тестов + 8/8 acceptance-сценариев оркестратора**.
