...
KEYWORDS_BY_TOOL: dict[str, set[str]] = {
    ...
    "watch_backup": {
        "следи за резервной копией",
        "контроль backup",
        "контроль бэкап",
        "свежесть резервной копии",
    },
    "list_backup_watches": {
        "какие backup отслеживаются",
        "контроль резервных копий",
    },
    "remove_backup_watch": {
        "не следи за backup",
        "удали контроль резервной копии",
    },
    "watch_package_update": {
        "следи за обновлением пакета",
        "обновление python пакета",
        "новая версия пакета",
        "контроль обновлений",
    },
    "list_package_update_watches": {
        "какие обновления отслеживаются",
        "контроль пакетов",
    },
    "remove_package_update_watch": {
        "не следи за обновлением пакета",
        "удали контроль пакета",
    },
}
...
ACTION_MARKERS = (
    ...
    "поищи", "прочитай", "посмотри", "чекни", "перейди", "проверь",
    "проанализируй", "исправь",
