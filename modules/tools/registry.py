...
execute_python_tool = {
    ...
    "function": {
        ...
        "description": "Отключено политикой безопасности. Не выбирайте этот инструмент; используйте специализированные инструменты файлов, Git, браузера или терминала.",
        "parameters": {
            "type": "object",
            "properties": {
...
write_in_application_tool = {
    ...
    "function": {
        ...
        "description": (
            "Открывает или активирует приложение, создаёт документ и вводит готовый текст. "
            "Для Obsidian создаёт реальный файл активного vault и перечитывает его; "
            "в остальных редакторах считывает текст обратно после вставки. Успех "
            "возвращается только при подтверждённом совпадении содержимого."
        ),
        "parameters": {
            "type": "object",
            "properties": {
