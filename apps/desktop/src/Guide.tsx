  ...
  ru: [
    {
      ...
      body: "Не называйте инструменты. Опишите конечный результат и важные ограничения — Rynne сама разложит задачу, найдёт tools и проверит итог.",
      bullets: [
        "Добавляйте контекст: приложение, сайт, файл или активный workspace.",
        "Составные команды можно давать одной фразой.",
        "Продолжайте коротко: «теперь там открой активность» — Rynne помнит цель.",
      ],
      examples: [
    ...
    {
      icon: Wrench,
      eyebrow: "КАК RYNNE РАБОТАЕТ",
      title: "Tools, skills и проверяемый результат",
      body: "Rynne начинает с компактного набора возможностей, а затем подгружает нужные инструменты из полного локального и MCP-каталога.",
      bullets: [
    ...
    },
    {
      ...
      bullets: [
        "Wake «Рин»: дождитесь индикатора, скажите имя и после короткой паузы команду.",
        "«Слушать»: речь отправляется без ключевого слова.",
        "«Выкл.»: микрофон не используется.",
        "Во время TTS действует акустическая защита, чтобы Rynne не услышала саму себя.",
        "В Настройках доступны 5 локальных русских голосов Silero, 6 английских Groq Orpheus, Auto/RU/EN, стиль, скорость и предпрослушивание.",
      ],
      examples: ["Рин… открой календарь и покажи встречи на сегодня.", "Рин, давай — голосовое подтверждение proactive-подсказки."],
    },
    {
      icon: Radio,
      eyebrow: "RYNNE РЯДОМ",
      ...
      bullets: [
        ...
        "Предложение требует второго клика или голосового «Рин, давай».",
    ...
    },
    {
      icon: Code2,
      eyebrow: "СВОИ SKILLS",
      title: "Научите Rynne вашему workflow",
    ...
    },
    {
      ...
      body: "В Settings можно хранить любое количество ключей Groq, OpenRouter и Gemini. Rynne ротирует их и использует один общий capability registry для native и MCP tools.",
      bullets: [
        ...
        "Если tool не виден сразу, Rynne может найти и подгрузить его через discover_tools.",
      ],
    },
    {
      icon: ShieldCheck,
      ...
      bullets: [
        ...
        "Rynne не должна повторять уже успешный side effect при fallback.",
    ...
    },
    {
      ...
      body: "Сначала посмотрите статус Core, микрофона и текущего tool в правой панели. Затем сформулируйте наблюдаемый результат — Rynne сможет проверить систему своими read-only tools.",
      bullets: [
        "«Проверь состояние Core и последние ошибки запуска».",
        "«Проверь микрофон, Vosk и STT, ничего не меняй».",
        "«Покажи активные процессы Rynne и останови только зависшие после подтверждения».",
  ...
  en: [
    {
      ...
      body: "You do not need to name tools. State the final result and important constraints — Rynne will decompose the task, find capabilities, and verify the outcome.",
      bullets: [
        "Include context: the app, website, file, or active workspace.",
        "Give multi-step tasks in one message.",
        "Continue naturally: “now open Activity there” — Rynne keeps the goal in context.",
      ],
      examples: [
    ...
    {
      icon: Wrench,
      eyebrow: "HOW RYNNE WORKS",
      title: "Tools, skills, and verifiable outcomes",
      body: "Rynne starts with a compact capability set, then loads the right tools from the full local and MCP catalog on demand.",
      bullets: [
        ...
        "If a required outcome is missing, Rynne reports a concrete blocker instead of claiming success.",
      ],
    },
    {
      icon: Mic,
      ...
      bullets: [
        "Wake “Rynne”: wait for the indicator, say the name, pause briefly, then say the command.",
        "Listen: recognize speech without a wake word.",
        "Off: do not use the microphone.",
        "An acoustic guard prevents Rynne from transcribing its own TTS output.",
        "Settings offers 5 local Russian Silero voices, 6 English Groq Orpheus voices, Auto/RU/EN, style, speed, and previews.",
      ],
      examples: ["Rynne… open my calendar and show today's meetings.", "Rynne, go ahead — confirm a proactive suggestion by voice."],
    },
    {
      icon: Radio,
      eyebrow: "RYNNE NEARBY",
      ...
      bullets: [
        ...
        "A suggestion requires a second click or the voice phrase “Rynne, go ahead.”",
    ...
    },
    {
      ...
      title: "Teach Rynne your workflow",
    ...
    },
    {
      ...
      body: "Settings can store any number of Groq, OpenRouter, and Gemini keys. Rynne rotates them and exposes native and MCP tools through one capability registry.",
      bullets: [
        ...
        "If a capability is deferred, Rynne can find and load it through discover_tools.",
      ],
    },
    {
      icon: ShieldCheck,
    ...
    },
    {
      ...
      body: "Check Core, microphone, and active-tool status in the side panel. Then describe the observed failure — Rynne can inspect it with read-only tools.",
      bullets: [
        "“Check Core health and the latest startup errors.”",
        "“Check the microphone, Vosk, and STT without changing anything.”",
        "“List Rynne processes and stop only stale ones after confirmation.”",
  ...
  return (
    <div className="guide-view">
      <section className="guide-hero">
        <span className="guide-orb"><RynneMark size={70} /></span>
        <div>
          <span className="eyebrow">{isRu ? "ПАМЯТКА RYNNE" : "RYNNE HANDBOOK"}</span>
      ...
      <section className="guide-footer">
        <BookOpen size={18} />
        <p>{isRu
          ? "Совет: если Rynne остановилась слишком рано, не повторяйте всю команду — скажите, какой результат ещё не достигнут. Goal ledger продолжит исходную задачу."
          : "Tip: if Rynne stops too early, do not repeat the whole request — state which outcome is still missing. The goal ledger will continue the original task."}</p>
      </section>
    </div>
  );
}
